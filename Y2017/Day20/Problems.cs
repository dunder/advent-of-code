...
namespace Y2017.Day20 {
    ...
    public class Particles {
        public static int ClosestToOrigo(string[] input) {
        ...
        public static int LeftAfterCollisions(string[] input) {
    ...
    public class Particle {
        ...
        public int TotalAcceleration => Math.Abs(Acceleration.X * Acceleration.X) + Math.Abs(Acceleration.Y * Acceleration.Y) + Math.Abs(Acceleration.Z * Acceleration.Z);
        ...
        public Particle Tick() {
            ...
            return new Particle(new Triple(px, py, pz), new Triple(vx, vy, vz), new Triple(Acceleration.X, Acceleration.Y, Acceleration.Z));
        }
        ...
        private int Distance() {
            return Math.Abs(Position.X * Position.X) + Math.Abs(Position.Y * Position.Y) + Math.Abs(Position.Z * Position.Z);
        }
