...
namespace Y2017.Day11 {
    public class Problems {
        ...
        public void Problem1() {
            ...
            var result = HexagonPath.DistanceToDestination(input);
        ...
        public void Problem2() {
            ...
            var result = HexagonPath.Furthest(input);

            Assert.Equal(1493, result);
    ...
    public class HexagonPath {
        ...
        public static int Furthest(string movements) {
            ...
            return all.Max(p => (Math.Abs(p.Y) - Math.Abs(p.X)) / 2 + Math.Abs(p.X));
        }
