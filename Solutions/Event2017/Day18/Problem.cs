...
namespace Solutions.Event2017.Day18
{
    public class Problem : ProblemBase
    {
        ...
        public override string FirstStar()
        {
            ...
            var result = DuetAssembly.RecoveredFrequency(input.ToArray());
        ...
        {
            var input = ReadLineInput();
            var result = DuetAssembly.DualSendCount(input.ToArray());
            return result.ToString();
        }
    }
    ...
    public class DuetAssembly
    {
        ...
        public static long DualSendCount(string[] input)
        {
            ...
            do
            {
                DualInterpreter(0, input, instructionCounters, registersProgram0, messagesFrom0To1, messagesFrom1To0,
                    sendCounters);
                DualInterpreter(1, input, instructionCounters, registersProgram1, messagesFrom1To0, messagesFrom0To1,
                    sendCounters);
