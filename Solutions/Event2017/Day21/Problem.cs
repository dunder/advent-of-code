...
namespace Solutions.Event2017.Day21
{
    ...
    public class PixelArt {
        public static int CountPixelsOnAfterExpansion(IList<string> input, int iterations) {
        ...
        public static Dictionary<PixelSet, PixelSet> ReadRules(IList<string> input) {
